<template>
  <v-container fluid>
    <v-row align="center" justify="center">
      <v-col lang="less">
        <v-row align="center" justify="center" v-if="songdetail.al.picUrl">
        ...
        <v-row align="center" justify="center">
          <audio :src="songurl.url" ref="audio" controls autoplay="autoplay" hidden/>
          <h3 class="pt-2 text-center">{{songdetail.name}}</h3>
          <h4 class="pt-2 text-center">
            <span v-for="(item, index) in songdetail.ar" v-bind:key="(item, index)">{{item.name}}&nbsp;</span>
          </h4>
        </v-row>
        <v-row class="pt-2">
          <v-divider></v-divider>
              ...
              <v-list-item :key="item.commentId">
                ...
                <v-list-item-content>
                  ...
                  <template v-for="item in item.beReplied">
                    <div class="pt-2" :key="item.beRepliedCommentId">
                      <v-divider></v-divider>
